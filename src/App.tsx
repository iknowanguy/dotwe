...
export default function App() {
  const [currentPage, setCurrentPage] = useState<'home' | 'privacy' | 'terms' | 'account-deletion'>('home');
  ...
  if (currentPage === 'account-deletion') {
            ...
            <div className="space-y-8">
              <div>
                ...
                <ul className="space-y-4">
                  <li>
                    <button onClick={() => setCurrentPage('privacy')} className="text-gray-600 hover:text-gray-900 transition-colors">
                      Privacy and Policy
                    </button>
                  </li>
                  <li>
                    <button onClick={() => setCurrentPage('terms')} className="text-gray-600 hover:text-gray-900 transition-colors">
                      Terms & Conditions
                    </button>
                  </li>
                  <li>
                    <button onClick={() => setCurrentPage('account-deletion')} className="text-gray-600 hover:text-gray-900 transition-colors">
                      Account Deletion
                    </button>
                  </li>
                </ul>
