  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        {/* Title */}
        <h1 className="text-center mb-16">Privacy Policy</h1>

        {/* Summary Box */}
        <div className="bg-gray-50 rounded-2xl p-8 md:p-12 mb-16">
          <h2 className="mb-6">For Your Privacy</h2>
        ...
        <div className="prose prose-gray max-w-none space-y-12">
          ...
          {/* Section 2 */}
          <section>
            <h2>2. The Core Principle: Data Minimization and The Trust Graph Moat</h2>
            <p className="text-gray-700">
          ...
          {/* Section 3 */}
          <section>
            <h2>3. Data We Collect and The Purpose of Collection</h2>
            <p className="text-gray-700">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="border border-gray-300 p-4 text-left">Type of Data Collected</th>
                    <th className="border border-gray-300 p-4 text-left">Purpose of Collection (Legal Basis)</th>
                  </tr>
                </thead>
                <tbody className="text-gray-700">
                  <tr>
                    <td className="border border-gray-300 p-4"><strong>A. Provided Directly (Account Setup)</strong></td>
                    <td className="border border-gray-300 p-4"><strong>Account Registration Data:</strong> Full Name, Professional Email Address, Job Title, Company/Organization, Profile Photo (optional), Password (encrypted).</td>
                    <td className="border border-gray-300 p-4">To establish your unique professional identity, personalize the Service, and secure your account. (Contractual Necessity)</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-4"><strong>A. Provided Directly (Graph Building)</strong></td>
                    <td className="border border-gray-300 p-4"><strong>Network Metadata:</strong> We collect <strong>encrypted, one-way hashed</strong> versions of your professional contacts' names and associated organizations/roles from your phonebook or synced third-party applications. <strong>(We do not store raw phone numbers, full contact lists, or unencrypted private data).</strong></td>
                    <td className="border border-gray-300 p-4">To build the foundational <strong>Trust Graph</strong> and calculate multi-hop connection paths (L1, L2, L3) for routing requests. (Explicit User Consent/Legitimate Interest)</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-4"><strong>A. Provided Directly (Utility)</strong></td>
                    <td className="border border-gray-300 p-4"><strong>Intent Data:</strong> The content of your specific broadcast requests (e.g., "Need an introduction to a seed-stage VC in NYC," "Looking for a contract ML Engineer").</td>
                    <td className="border border-gray-300 p-4">To fulfill the core utility of the Service—matching and routing your need to the most qualified path. <strong>This content is only shared with the L1 human router.</strong> (Contractual Necessity)</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-4"><strong>B. Collected Automatically (Usage)</strong></td>
                    <td className="border border-gray-300 p-4"><strong>Usage Data:</strong> Device IDs, IP Address, Mobile Operating System, Browser Type, Session Duration, pages/screens viewed, features used (e.g., successful routes executed vs. failed requests).</td>
                    <td className="border border-gray-300 p-4">To monitor the performance of the routing engine, track key metrics (e.g., velocity, successful introductions), and improve the app's functionality and security. (Legitimate Interest)</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 p-4"><strong>B. Collected Automatically (Technical)</strong></td>
                    <td className="border border-gray-300 p-4"><strong>Location Data (Approximate):</strong> Derived from IP address, such as city or state, <strong>never precise GPS data.</strong></td>
                    <td className="border border-gray-300 p-4">To localize professional network searches (e.g., filtering a search for a "Product Designer in Bangalore"). (Legitimate Interest)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* Section 5 */}
          <section>
            <h2>5. Data Sharing and Disclosure (The Zero-Sharing Guarantee)</h2>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700">We take the security of your data seriously.</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
